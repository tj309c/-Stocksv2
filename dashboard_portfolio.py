...
def show_portfolio_dashboard(components):
    ...
    <div style="text-align: center; padding: 20px 0;">
        <h1 style="margin: 0; font-size: 3em;">💼 PORTFOLIO MANAGER</h1>
        <p style="color: #888; font-size: 1.2em; margin: 10px 0;"><i>Optimize your portfolio like a pro</i> 📈</p>
    </div>
    ...
    if optimal_weights and "error" not in optimal_weights:
        ...
        with col2:
            ...
            fig = go.Figure(data=[go.Pie(
                ...
                values=weights,
                hole=0.4,
                marker=dict(colors=['#00d4ff', '#ff6b6b', '#51cf66', '#ffd43b', '#a78bfa', '#fb923c'])
            )])
