...
def test_analysis_engine():
    ...
    try:
        ...
        if "error" in dcf_result:
            log_result("calculation_tests", "DCF calculation (no cash flow)", "WARN", 
                      "Expected error with no cash flow data")
        else:
        ...
        if "error" not in multiples_result:
            ...
            log_result("calculation_tests", "Multiples valuation", "WARN", multiples_result.get("error"))
